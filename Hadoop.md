...
### 4.测试文件上传(hdfs)
```shell
root@localhost /usr/local/hadoop/etc/hadoop 16:48:22 # vim worlds
  1 hello world
  2 hello chaoren
  3 hello bianfuxia
  4 hello chaoren
  5 hello zhizhuxia
root@localhost /usr/local/hadoop/etc/hadoop 17:11:25 # hadoop fs -put worlds hdfs://127.0.0.1:9000/words
root@localhost /usr/local/hadoop/etc/hadoop 17:12:25 # hadoop fs -ls /
Found 2 items
-rw-r--r--   1 root supergroup        179 2016-11-29 00:41 /hosts
-rw-r--r--   1 root supergroup         72 2016-11-29 17:12 /words
root@localhost /usr/local/hadoop/etc/hadoop 17:12:40 # hadoop fs -cat /words
hello world
hello chaoren
hello bianfuxia
hello chaoren
...
### 5.mapreduce测试
```shell
root@localhost /usr/local/hadoop/share/hadoop/mapreduce 17:22:47 # hadoop jar hadoop-mapreduce-examples-2.7.3.jar wordcount hdfs://127.0.0.1:9000/words hdfs://127.0.0.1:9000/ouput
16/11/29 17:24:20 INFO client.RMProxy: Connecting to ResourceManager at /0.0.0.0:8032
16/11/29 17:24:26 INFO input.FileInputFormat: Total input paths to process : 1
16/11/29 17:24:26 WARN hdfs.DFSClient: Caught exception 
...
java.lang.InterruptedException
        ...
        at org.apache.hadoop.hdfs.DFSOutputStream$DataStreamer.endBlock(DFSOutputStream.java:370)
        at org.apache.hadoop.hdfs.DFSOutputStream$DataStreamer.run(DFSOutputStream.java:546)
16/11/29 17:24:26 INFO mapreduce.JobSubmitter: number of splits:1
16/11/29 17:24:27 INFO mapreduce.JobSubmitter: Submitting tokens for job: job_1480344067909_0001
16/11/29 17:24:31 INFO impl.YarnClientImpl: Submitted application application_1480344067909_0001
16/11/29 17:24:33 INFO mapreduce.Job: The url to track the job: http://localhost:8088/proxy/application_1480344067909_0001/
16/11/29 17:24:33 INFO mapreduce.Job: Running job: job_1480344067909_0001
16/11/29 17:25:30 INFO mapreduce.Job: Job job_1480344067909_0001 running in uber mode : false
16/11/29 17:25:30 INFO mapreduce.Job:  map 0% reduce 0%
16/11/29 17:26:05 INFO mapreduce.Job:  map 100% reduce 0%
16/11/29 17:26:29 INFO mapreduce.Job:  map 100% reduce 100%
16/11/29 17:26:32 INFO mapreduce.Job: Job job_1480344067909_0001 completed successfully
16/11/29 17:26:33 INFO mapreduce.Job: Counters: 49
        File System Counters
                FILE: Number of bytes read=76
                FILE: Number of bytes written=237359
        ...
        Job Counters 
                ...
                Total time spent by all maps in occupied slots (ms)=33364
                Total time spent by all reduces in occupied slots (ms)=17497
                Total time spent by all map tasks (ms)=33364
                Total time spent by all reduce tasks (ms)=17497
                Total vcore-milliseconds taken by all map tasks=33364
                Total vcore-milliseconds taken by all reduce tasks=17497
                Total megabyte-milliseconds taken by all map tasks=34164736
                Total megabyte-milliseconds taken by all reduce tasks=17916928
        Map-Reduce Framework
                ...
                Physical memory (bytes) snapshot=282365952
                Virtual memory (bytes) snapshot=3736694784
                Total committed heap usage (bytes)=140341248
        Shuffle Errors
                BAD_ID=0
                CONNECTION=0
                IO_ERROR=0
        ...
        File Output Format Counters 
                Bytes Written=50
root@localhost /usr/local/hadoop/share/hadoop/mapreduce 17:29:58 # hadoop fs -cat hdfs://127.0.0.1:9000/ouput/part-r-00000  
bianfuxia       1 #bianfuxia出现1次
chaoren 2		  #chaoren出现2次
hello   5		  #hello出现5次
world   1		  #word出现1次
zhizhuxia       1 #zhizhuxia出现1次
>>>>>>> 0da2fb77ebefedc7a09afc98be1633565dfa52a9
```